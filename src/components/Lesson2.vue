  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1">
      ...
      <div class="flex-1 flex items-center justify-center p-6 flex-col gap-1">
        <img alt="презентация" src="@/assets/pres.jpg">
        <div class="bg-gray-800 text-white text-xl p-6 rounded-lg shadow-md w-full max-w-3xl">
          ...
          <p v-else class="text-center text-gray-400">Subtitles will appear here...</p>
        </div>
      </div>
...
export default {
  data() {
    return {
      ...
      subtitles: "welcome to today's lesson on introduction to neural networks. neural networks is ...",
      chatMessages: [
        {
          user: "Jone Doe",
          text: {
